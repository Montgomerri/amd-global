      ...
      paystack.newTransaction({
        ...
        onSuccess: async (transaction: any) => {
          ...
          try {
            ...
            window.location.href = `/success?ref=${transaction.reference}&order=${
              order?.number || ""
            }`;
          } catch (err) {
          ...
          <div className="flex-1">
            ...
            <div className="space-y-4">
              {items.map((item) => (
                <div
                  key={item.id}
                  className="relative flex gap-4 bg-white rounded-2xl p-4 shadow-sm border border-gray-100"
                >
                  <button
            ...
            <div className="mt-6 bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
              ...
              {showDiscount && (
                <div className="mt-3 flex gap-2">
                  ...
                  />
                  <button className="px-4 py-2 bg-black text-white text-sm rounded-lg">
                    Apply
                  </button>
                </div>
              )}
