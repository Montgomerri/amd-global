  ...
  if (loading) {
    return (
      <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="rounded-3xl bg-white border border-gray-100 shadow-sm px-6 py-5 text-sm text-gray-600">
      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500">
            <Shield className="h-4 w-4 text-[#9AE600]" />
            Secure profile
          </div>
        </div>

        <div className="overflow-hidden rounded-[2rem] bg-white shadow-[0_18px_50px_rgba(23,34,56,0.08)] border border-gray-100">
          <div className="h-28 sm:h-32 bg-gradient-to-r from-[#eef6cc] via-[#f7fbec] to-[#f3f6ff]" />
              ...
              <div className="-mt-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-20 h-20 rounded-full bg-white p-1 shadow-lg ring-4 ring-white overflow-hidden flex items-center justify-center">
                    <div className="w-full h-full rounded-full bg-[#9AE600] flex items-center justify-center text-gray-900 text-2xl font-bold">
                      {initials}
                    </div>
                  </div>
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#9AE600] px-5 py-3 text-sm font-semibold text-gray-900 shadow-sm hover:opacity-90 transition"
                >
              ...
              <div className="grid gap-5">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-gray-100 bg-white px-4 py-3 text-sm text-gray-800 outline-none placeholder:text-gray-300 disabled:bg-gray-50 disabled:text-gray-500"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-2xl border border-gray-100 bg-white px-10 py-3 text-sm text-gray-800 outline-none disabled:bg-gray-50 disabled:text-gray-500"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <MapPin className="pointer-events-none absolute left-4 top-3.5 h-4 w-4 text-gray-400" />
                    <input
                      value={form.address}
